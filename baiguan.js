/*
 ...
 变量：baiguanCK='xxxx@12345678910#abcdefg '  多个账号用 @ 或者 换行 分割
 定时一天三次
 cron 10 8,10,19 * * *
 ...
 */
 ...
 let cookiesArr = [],
   message = "",
   channelId = ["628c3214dfc3c004baef7f98", "606ff308ad61a43e7054cf3b", "6257a3cdad61a47ce36789d3", "628b9aa7fe3fc15d06739c58", "628b9a6bb40eef5152d3d77f", "606566eaad61a43e7054b600", "628b4ea7de224a649d227366"]
 cookie = ($.isNode() ? process.env.baiguanCK : $.getdata("baiguanCK")) || ``
 helpAu = ($.isNode() ? process.env.baiguanhelpAu : $.getdata("baiguanhelpAu")) || true
 //开始===============================================================================================
 !(async () => {
 ...
 async function main() {
   if ($.userId) {
     ...
     if (helpAu == true) {
       //console.log(`【环境变量：baiguanhelpAu 默认为True 前往助力作者】`)
       await invite()
     }
     console.log(`【查询账号信息】`)
 ...
 async function article() {
   let body = `?channel_id=${channelId[Math.floor(Math.random()*channelId.length)]}&isDiFangHao=false&is_new=1&list_count=${Math.floor(Math.random()*5+1)*10}&size=20&start=${Date.now()}`
   return new Promise(resolve => {
