/*
 ...
 变量：haiyanCK='xxxx@12345678910#abcdefg '  多个账号用 @ 或者 换行 分割
 定时一天三次
 cron 10 8,10,19 * * *
 */
 const $ = new Env('爱海盐')
 ...
 let cookiesArr = [],
   ...
   channelId = [
    ...
    "63573b5c06287f04c31913bd", 
    "63573b82a8a2e804c44a0055", 
    "638db5cd7d9bcd1b7610b120", 
    "6357999806287f04c3191637"]
 cookie = ($.isNode() ? process.env.haiyanCK : $.getdata("haiyanCK")) || ``
 helpAu = ($.isNode() ? process.env.haiyanhelp : $.getdata("haiyanhelp")) || true
 //开始===============================================================================================
 !(async () => {
 ...
 async function main() {
   if ($.userId) {
     ...
     if (helpAu == true) {
       //console.log(`【环境变量：haiyanhelp 默认为True 前往助力作者】`)
       await invite()
     }
     console.log(`【查询账号信息】`)
